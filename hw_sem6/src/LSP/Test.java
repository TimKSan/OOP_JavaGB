package LSP;
//    Проверяем класс QuadRangle и отнаследованные от него классы Rectangle и Square,  
//    если мы заменим все использования класса QuadRangle на Rectangle или Square, 
//    ничего не меняется в работе программы. Ведь классы Rectangle и Square всего лишь
